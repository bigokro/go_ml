...
// CollaborativeFilter Collaborative filtering implementation, this algorithm is
// able to determine the items with a best fit for items not yet rated in a
// matrix of users and items calcifications:
